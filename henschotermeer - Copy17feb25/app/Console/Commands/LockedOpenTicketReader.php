...
class LockedOpenTicketReader extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:LockedOpenTicketReader {device}';
     ...
     * @var string
     */
    protected $description = 'Gate permanently opened';
    ...
    public function handle()
    {
        ...
        if ($device && $device->barrier_status != 1) {
            $details = array();
            $ip = $device->device_ip;
