...
class LocationDevices extends Model {
    ...
    {
        return $this->hasMany(DevicePort::class, 'device_id');
    }
    public function relatedTicketReader()
    {
        return $this->hasMany(DeviceTicketReaders::class, 'device_id');
    }
    public function relatedOds()
    {
        return $this->hasMany(DeviceTicketReaders::class, 'device_id');
    }
    public function lightConditions()
    {
        return $this->hasOne(LightCondition::class, 'device_id');
    }
