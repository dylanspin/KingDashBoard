...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">@lang('unwanted_character.add_character')</h3>
                    ...
                    <form 
                        id="parkingRule" 
                        action="{{url('unwanted-character/create')}}" 
                        method="POST" 
                        ...
                        <div id="rootwizard">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab1" data-toggle="tab">@lang('unwanted_character.add_character')</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    <h2 class="hidden">&nbsp;</h2>
                                    <div class="form-group {{ $errors->first('character_unwanted', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input 
                                                ...
                                                value="{!! old('character_unwanted') !!}"/>

                                            {!! $errors->first('character_unwanted', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
