...
@section('content')
                ...
                <div class="white-box bg-danger color-box col-md-12">
                    <a href="#">
                        ...
                        <div class="col-md-5 col-xs-5 text-right widget3_con">
                            ...
                            <h4 class="color-white">{{ $widget_1->online_parking_spot ?? "" }}</h4>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="white-box device_heading color-box col-md-12 mb-0 p-10">
                    ...
                    <div class="col-md-3 devices_collapse_actions pt-10 text-right">
                        <i class="fa fa-plus f-24 color-white cursor-pointer devices_collapse_actions_show"
                            data-toggle="collapse" data-target="#devices_section"></i>
                    </div>
                </div>
            </div>
        </div>
                ...
                @if (count($devices) > 0)
                    @foreach ($devices as $device)
                                ...
                                <div class="bg-primary color-white col-md-12 col-xs-12  pb-15 pl-0 pr-0">
                                    <div class="col-md-12 col-xs-12 pl-0 pr-0 pt-5 pb-5 header-device-section">
                                        <div class="col-sm-6 col-xs-6">
                                            <h6 class="box-title text-left color-white wrap-word-custom f-17"
                                                data-toggle="tooltip" title="{{ strtoupper($device['name']) }}">
                                                {{ strtoupper($device['name']) }}</h6>
                                        </div>
                                        <div class="col-sm-6 col-xs-6">
                                            <h6
                                                class="box-title text-right cursor-pointer color-white f-17 wrap-word-custom">
                                                @lang('dashboard.transaction') <i class="fa fa-chevron-down show_transactions"></i><i
                                                    class="fa fa-chevron-up hide_transactions hidden"></i></h6>
                                        </div>
                                    </div>
                                                ...
                                                @foreach ($device['transactions'] as $ticket_reader_device_transactions)
                                                    <div class="col-md-12 col-xs-12 p-0">
                                                        <a style="color:white!important" target="_blank"
                                                            href="{{ url('/transaction/1/' . $ticket_reader_device_transactions['id']) }}">{{ $ticket_reader_device_transactions['content'] }}</a>
                                                    </div>
                                                @endforeach
                                            </div>
                                            <div class="col-md-4 col-xs-4 text-center pt-35">
                                                <a target="_blank"
                                                    href="/device_transaction/tr/{{ $device['id'] }}"><button
                                                        class="btn btn-primary-transactions">More</button></a>
                                            </div>
                                        @else
                                    ...
                                    <div class="other_content">
                                        <div class="col-md-6 col-xs-6 gates h-100">
                                            @if ($device['barrier_status'] >= 1)
                                                <div class="barier-locked-opened barier-locked-opened-{{ $device['id'] }} text-center {{ $device['barrier_status'] == 1 ? '' : 'hidden' }}"
                                                    data-device_id="{{ $device['id'] }}" style="position:relative">
                                                    <img class="filter" width="100"
                                                        src="{{ asset('plugins/images/icons/bo.png') }}" alt="Transaction">
                                                    <i class="fa fa-lock f-35 color-red barrier-open-lock"></i>
                                                </div>
                                                <div class="barier-locked-closed barier-locked-closed-{{ $device['id'] }} text-center pt-20 {{ $device['barrier_status'] == 2 ? '' : 'hidden' }}"
                                                    data-device_id="{{ $device['id'] }}" style="position:relative">
                                                    <img class="filter" width="100"
                                                        src="{{ asset('plugins/images/icons/b.png') }}" alt="Transaction">
                                                    <i class="fa fa-lock f-35 color-red barrier-close-lock"></i>
                                                </div>
                                                <div class="barier-always-access barier-always-access-{{ $device['id'] }} text-center pt-20 {{ $device['barrier_status'] == 3 ? '' : 'hidden' }}"
                                                    data-device_id="{{ $device['id'] }}" style="position:relative">
                                                    <img class="filter" width="100"
                                                        src="{{ asset('plugins/images/icons/b.png') }}" alt="Transaction">
                                            ...
                                            @else
                                                <div class="barier-closed barier-closed-{{ $device['id'] }} text-center pt-20 {{ !$device['is_opened'] ? '' : 'hidden' }}"
                                                    data-device_id="{{ $device['id'] }}">
                                                    <img class="filter" width="100"
                                                        src="{{ asset('plugins/images/icons/b.png') }}"
                                                        alt="Transaction">
                                                </div>
                                                <div class="barier-opened barier-opened-{{ $device['id'] }} text-center {{ $device['is_opened'] ? '' : 'hidden' }}"
                                                    data-device_id="{{ $device['id'] }}">
                                                    <img class="filter" width="100"
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            @if ($device['is_synched'])
                                                <div
                                                    class="col-md-12 col-xs-12 text-center pt-10 gate_open_spinner overlay_open_gate hidden pr-0">
                                                    <i class="fa fa-spinner fa-spin f-60  "> </i>
                                                </div>
                                                @if ($device['is_opened'])
                                                    <div class="col-md-12 col-xs-12 open_con text-right pt-5 pr-0 pl-0">
                                                        <div
                                                            class="col-md-12 col-xs-12 btn-group p-0 pull-right btn-open-gate-vehicle-active-con hidden">
                                                            <button type="button" data-device_id="{{ $device['id'] }}"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @if ($device['has_always_access'])
                                                                    <li
                                                                        style="{{ $device['barrier_status'] == 3 ? 'display:none;' : '' }}">
                                                                        <a href="javascript:void(0)"
                                                                            onclick="change_barrier_status({{ $device['id'] }}, 3)">
                                                                            @lang('dashboard.always_access')</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0)"
                                                                            onclick="change_barrier_status({{ $device['id'] }}, 0)">
                                                                            @lang('dashboard.verify_access')</a>
                                                                    </li>
                                                                    <li>
                                                                        <hr style="margin:5px;" />
                                                                    </li>
                                                                @endif
                                                                <li
                                                                    style="{{ $device['barrier_status'] == 1 ? 'display:none;' : '' }}">
                                                                    <a href="javascript:void(0)"
                                                                        onclick="change_barrier_status({{ $device['id'] }}, 1)">
                                                                        @lang('dashboard.locked_open')</a>
                                                                </li>
                                                                <li
                                                                    style="{{ $device['barrier_status'] == 2 ? 'display:none;' : '' }}">
                                                                    <a href="javascript:void(0)"
                                                                        onclick="change_barrier_status({{ $device['id'] }}, 2)">
                                                                        @lang('dashboard.locked_closed')</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)"
                                                                        onclick="change_barrier_status({{ $device['id'] }}, 0)">
                                                                        @lang('dashboard.unlock')</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div
                                                            class="col-md-12 col-xs-12 btn-group p-0 pull-right {{ $device['barrier_status'] > 0 ? 'btn-danger' : 'btn-primary' }} btn-open-gate-vehicle-non-active">
                                                            @if ($device['barrier_status'] < 1)
                                                                <button type="button"
                                                                    data-device_id="{{ $device['id'] }}"
                                                                    class="col-md-10 col-xs-10 btn btn-open-gate-group p-3 btn-open-gate btn-open-gate-vehicle-active"
                                                            ...
                                                            @else
                                                                <button
                                                                    class="col-md-10 col-xs-10 btn btn-open-gate-group p-3 btn-open-gate">
                                                                    @if ($device['barrier_status'] == 1)
                                                    ...
                                                    <div class="col-md-12 col-xs-12 close_con text-right pt-5 pr-0 pl-0">
                                                        <div
                                                            class="col-md-12 col-xs-12 btn-group p-0 pull-right btn-close-gate-vehicle-active-con">
                                                            <button type="button" data-device_id="{{ $device['id'] }}"
                                                        ...
                                                        <div
                                                            class="col-md-12 col-xs-12 btn-group p-0 pull-right {{ $device['barrier_status'] > 0 ? 'btn-danger' : 'btn-primary' }} btn-close-gate-vehicle-non-active hidden">
                                                            @if ($device['barrier_status'] < 1)
                                                                <button type="button"
                                                                    data-device_id="{{ $device['id'] }}"
                                                            ...
                                                            @else
                                                                <button
                                                                    class="col-md-10 col-xs-10 btn btn-close-gate-group p-3 btn-close-gate">
                                                                    @if ($device['barrier_status'] == 1)
                                                                        @lang('dashboard.locked_open')
                                                                    @elseif($device['barrier_status'] == 2)
                                                                        @lang('dashboard.locked_closed')
                                                ...
                                                @else
                                                    <div class="col-md-12 col-xs-12 open_con text-right pt-5 pr-0 pl-0">
                                                        <div
                                                            class="col-md-12 col-xs-12 btn-group p-0 pull-right btn-open-gate-vehicle-active-con">
                                                            <button type="button" data-device_id="{{ $device['id'] }}"
                                                                class="col-md-10 col-xs-10 btn btn-open-gate-group p-3 btn-open-gate btn-open-gate-vehicle-active"
                                                                style="">@lang('dashboard.open')</button>
                                                            <button type="button"
                                                        ...
                                                        <div
                                                            class="col-md-12 col-xs-12 btn-group p-0 pull-right {{ $device['barrier_status'] > 0 ? 'btn-danger' : 'btn-primary' }} btn-open-gate-vehicle-non-active hidden">
                                                            @if ($device['barrier_status'] < 1)
                                                                <button type="button"
                                                                    data-device_id="{{ $device['id'] }}"
                                                                    class="col-md-10 col-xs-10 btn btn-open-gate-group p-3 btn-open-gate btn-open-gate-vehicle-active"
                                                    ...
                                                    <div class="col-md-12 col-xs-12 close_con text-right pt-5 pr-0 pl-0">
                                                        <div
                                                            class="col-md-12 col-xs-12 btn-group p-0 pull-right btn-close-gate-vehicle-active-con hidden">
                                                            <button type="button" data-device_id="{{ $device['id'] }}"
                                                                class="col-md-10 col-xs-10 btn btn-close-gate-group p-3 btn-close-gate btn-close-gate-vehicle-active"
                                                                style="">@lang('dashboard.close')</button>
                                                            <button type="button"
                                                        ...
                                                        <div
                                                            class="col-md-12 col-xs-12 btn-group p-0 pull-right {{ $device['barrier_status'] > 0 ? 'btn-danger' : 'btn-primary' }} btn-close-gate-vehicle-non-active">
                                                            @if ($device['barrier_status'] < 1)
                                                                <button type="button"
                                                                    data-device_id="{{ $device['id'] }}"
                                                                    class="col-md-10 col-xs-10 btn btn-close-gate-group p-3 btn-close-gate btn-close-gate-vehicle-active">@lang('dashboard.close')</button>
                                                            @else
                                                                <button
                                                                    class="col-md-10 col-xs-10 btn btn-open-gate-group p-3 btn-close-gate">
                                                                    @if ($device['barrier_status'] == 1)
                                                                        @lang('dashboard.locked_open')
                                                                    @elseif($device['barrier_status'] == 2)
                                                                        @lang('dashboard.locked_closed')
                                        ...
                                        <div class="col-md-12 col-xs-12 pt-10">
                                            @if ($device['is_synched'])
                                                <p class="col-md-4 col-xs-4  text-left mb-0 pl-0" style="color: white">
                                                    <b>{{ $device['status'] }}</b></p>
                                            @else
                                                <p class="col-md-4 col-xs-4 text-left mb-0 pl-0 text-out-of-order"
                                                    style="color: {{ $device['status_color'] }}">
                                                    <b>{{ $device['status'] }}</b></p>
                                            @endif
                        ...
                        @elseif($device['available_device_id'] == 3)
                            <div
                                class="col-md-4 col-sm-12 col-xs-12 mb-20 device_item plate_reader_devices device_{{ $device['id'] }}">
                                <div
                                    class="bg-primary color-white col-md-12 col-xs-12 pb-15 pl-0 pr-0 device_non_stucked_{{ $device['id'] }}">
                                    <div class="col-md-12 col-xs-12 pl-0 pt-5 pr-0 pb-5 header-device-section">
                                        <div class="col-sm-6 col-xs-6">
                                            <h6 class="box-title text-left color-white f-17 wrap-word-custom"
                                                data-toggle="tooltip" title="{{ strtoupper($device['name']) }}">
                                                {{ strtoupper($device['name']) }}</h6>
                                        </div>
                                        <div class="col-sm-6 col-xs-6">
                                            <h6
                                                class="box-title text-right cursor-pointer f-17 color-white wrap-word-custom">
                                    ...
                                    <div class="transactions_con transactions_container hidden">
                                        @if (count($device['transactions']) > 0)
                                            ...
                                            <div class="col-md-4 col-xs-4 text-center pt-35">
                                                <a target="_blank"
                                                    href="/device_transaction/pr/{{ $device['id'] }}"><button
                                                        class="btn btn-primary-transactions">More</button></a>
                                            </div>
                                        @else
                                            <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="other_content ">
                                        <div class="col-md-6 pt-5 col-xs-6">
                                            @if ($device['barrier_status'] == 1)
                                                <div class="barier-locked-opened barier-locked-opened-{{ $device['id'] }} text-center"
                                                    data-device_id="{{ $device['id'] }}" style="position:relative">
                                                    <img class="filter" width="100"
                                                        src="{{ asset('plugins/images/icons/bo.png') }}"
                                                        alt="Transaction">
                                            ...
                                            @elseif($device['barrier_status'] == 2)
                                                <div class="barier-locked-closed barier-locked-closed-{{ $device['id'] }} text-center pt-20"
                                                    data-device_id="{{ $device['id'] }}" style="position:relative">
                                                    <img class="filter" width="100"
                                                        src="{{ asset('plugins/images/icons/b.png') }}"
                                                        alt="Transaction">
                                            ...
                                            @else
                                                @if (count($device['transactions']) > 0)
                                                    <div id="carousel-example-captions-{{ $device['id'] }}"
                                                        ...
                                                        <a href="#carousel-example-captions-{{ $device['id'] }}"
                                                            role="button" data-slide="prev"
                                                            class="left carousel-control" style="background-image:none;">
                                                            <span aria-hidden="true" class="fa fa-angle-left"></span>
                                                            <span class="sr-only">@lang('dashboard.prev')</span>
                                                        </a>
                                                        <a href="#carousel-example-captions-{{ $device['id'] }}"
                                                            role="button" data-slide="next"
                                                            class="right carousel-control" style="background-image:none;">
                                                            <span aria-hidden="true" class="fa fa-angle-right"></span>
                                                            <span class="sr-only">@lang('dashboard.nxt')</span>
                                                        </a>
                                                    </div>
                                                @else
                                                    <div class="barier-closed pt-20 text-center"
                                                        data-device_id="{{ $device['id'] }}">
                                                        <img class="filter" width="150"
                                                            src="{{ asset('plugins/images/icons/lp1.png') }}"
                                                            alt="Transaction">
                                                    </div>
                                                @endif
                                            @endif
                                        ...
                                        <div class="col-md-6 col-xs-6 other_content_transaction pl-0">
                                            @if (count($device['transactions']) > 0)
                                                <div class="col-md-6 col-xs-6 text-right pt-5 pr-0 pl-0">
                                                    <button
                                                        class="btn col-md-12 btn-primary p-3 btn-open-gate btn-device-{{ $device['id'] }}">{{ $device['transactions']['0']['vehicle'] }}</button>
                                                </div>
                                                <div
                                                    class="col-md-6 col-xs-6 text-right pt-5 pr-0 pl-0 btn-device-link-{{ $device['id'] }}">
                                                    <a target="_blank"
                                                        href="{{ url('/transaction/1/' . $device['transactions']['0']['id']) }}"
                                                        class="redirect_lnk">
                                                        <button
                                                            class="btn col-md-12 btn-primary p-3 btn-close-gate">View</button></a>
                                                </div>
                                            @else
                                                @if ($device['has_gate'])
                                ...
                                <div
                                    class="bg-danger-device color-white col-md-12 col-xs-12 pl-0 pr-0 pb-15 hidden device_stucked_{{ $device['id'] }}">
                                    <div class="col-md-12 col-xs-12 pl-0 pt-5 pr-0 pb-5 header-device-section">
                                        <div class="col-sm-6 col-xs-6">
                                            <h6 class="box-title text-left color-white f-17 wrap-word-custom"
                                                data-toggle="tooltip" title="{{ strtoupper($device['name']) }}">
                                        ...
                                        <div class="col-sm-6 col-xs-6">
                                            <h6
                                                class="box-title text-right cursor-pointer f-17 color-white wrap-word-custom">
                                                @lang('dashboard.transaction')
                                                <i class="fa fa-chevron-down show_transactions"></i><i
                                                    class="fa fa-chevron-up hide_transactions hidden"></i>
                                            </h6>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-6 gates text-center  pt-10">
                                        <img class="filter default_img" width="70"
                                            src="{{ asset('plugins/images/icons/plate_reader_on1.png') }}"
                                            alt="Transaction">
                                        <img class="device_strucked_image hidden" width="130"
                                            src="{{ asset('plugins/images/icons/plate_reader_on.png') }}"
                                            alt="Transaction">
                                    </div>
                                    <div class="col-md-6 col-xs-6">
                                        <div class="col-md-12 col-xs-12 text-center pt-5">
                                            ...
                                            <input type="text" class="form-control plate_num_textbox"
                                                name="plate_num_textbox" value="">
                                            <div class="col-md-12 col-xs-12 text-center pt-5  pl-0 pr-0">
                                                <button
                                                    class="btn col-md-12 btn-primary btn-plate-reader btn-confidence">View</button>
                                            </div>
                                            <div class="col-md-12 col-xs-12 text-center pt-5 pl-0 pr-0">
                                                <form class="hidden updated_device_vehicle_num_form"
                                                    action="<?php echo url('dashboard/update_device_vehicle'); ?>" method="POST">
                                                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                                    <input type="hidden" name="device_booking_id"
                                                        class="device_booking_id">
                                                    <input type="hidden" name="updated_device_vehicle_num"
                                                        class="updated_device_vehicle_num">
                                                </form>
                                                <button class="btn col-md-12 col-xs-12 btn-primary  btn-plate-reader"
                                                    onclick="update_device_vehicle_number(this)">Update</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @elseif($device['available_device_id'] == 6)
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12 mb-20 device_item  device_{{ $device['id'] }}">
                                <div class="bg-primary color-white col-md-12 col-xs-12 pl-0 pr-0 pb-15">
                                    <div class="col-md-12 col-xs-12 pl-0 pt-5 pr-0 pb-5 header-device-section">
                                        <div class="col-sm-6 col-xs-6">
                                            <h6 class="box-title text-left  f-17  color-white wrap-word-custom"
                                                data-toggle="tooltip" title="{{ strtoupper($device['name']) }}">
                                                {{ strtoupper($device['name']) }}</h6>
                                        </div>
                                        {{-- <div class="col-sm-6 col-xs-6">
                            @if ($device['is_synched'])
                                <h6 class="box-title text-right cursor-pointer f-17 color-white wrap-word-custom "
                                    style="color: white!important">{{ $device['status'] }} <i
                                        class="fa fa-backward show_main_content hidden ml-10"></i> </h6>
                            @else
                                <h6 class="box-title text-right cursor-pointer f-17 color-white wrap-word-custom  text-out-of-order"
                                    style="color: {{ $device['status_color'] }}!important">
                                    {{ $device['status'] }} <i
                                        class="fa fa-backward show_main_content hidden ml-10"></i> </h6>
                            @endif
                        </div> --}}
                                        ...
                                        @if (count($device['vehicle_transactions']) > 0)
                                            <div class="col-md-9 col-xs-9">
                                                @foreach ($device['vehicle_transactions'] as $payment_terminal_device_transactions)
                                                    <div class="col-md-12 col-xs-12 p-0">
                                                        <a style="color:white!important" target="_blank"
                                                            href="{{ url('/transaction/2/' . $payment_terminal_device_transactions['id']) }}">{{ $payment_terminal_device_transactions['content'] }}</a>
                                                    </div>
                                                @endforeach
                                            </div>
                                            <div class="col-md-3 col-xs-3 text-center pt-35">
                                                <a target="_blank"
                                                    href="/device_transaction/ptv/{{ $device['id'] }}"><button
                                                        class="btn btn-primary-transactions">More</button></a>
                                            </div>
                                        @else
                                            <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="other_content ">
                                        <div class="col-md-6 col-xs-6 gates">
                                            <div class="barier-closed pt-10 text-center"
                                                data-device_id="{{ $device['id'] }}">
                                                <!--<i class="fa fa-credit-card-alt f-90"></i>-->
                                                <img class="filter" width="100"
                                                    src="{{ asset('plugins/images/icons/p1.png') }}" alt="Transaction">
                                            </div>
                                        </div>
                                        {{-- @php
                                            $related_switch = \App\DeviceTicketReaders::select('ticket_reader_id')
                                                ->where('device_id', $device['id'])
                                                ->first();
                                        @endphp --}}
                                        @if ($device['related_switch'] && ($device['open_relay'] || $device['close_relay']))
                                            <div class="col-md-6 col-xs-6 other_content_transaction pl-0">
                                                <div class="col-md-12 col-xs-12 open_con text-right pt-5 pr-0 pl-0">
                                                    <div
                                                        class="col-md-12 col-xs-12 btn-group p-0 pull-right btn-open-gate-vehicle-active-con">
                                                        <button type="button" data-device_id="{{ $device['id'] }}"
                                                            class="col-md-12 col-xs-12 btn btn-open-gate-group p-3 btn-open-gate"
                                                            onclick="open_payment_terminal({{ $device['id'] }},{{ $device['related_switch']}},{{$device['open_relay']}})">Open</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-xs-6 other_content_transaction pl-0">
                                                <div class="col-md-12 col-xs-12 open_con text-right pt-5 pr-0 pl-0">
                                                    <div
                                                        class="col-md-12 col-xs-12 btn-group p-0 pull-right btn-open-gate-vehicle-active-con">
                                                        <button type="button" data-device_id="{{ $device['id'] }}"
                                                            class="col-md-12 col-xs-12 btn btn-close-gate-group p-3 btn-open-gate"
                                                            onclick="close_payment_terminal({{ $device['id'] }},{{ $device['related_switch']}},{{$device['close_relay']}})">Close</button>
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <div class="col-md-12 col-xs-12 open_con text-right pt-10 pr-0">
                                                <button data-device_id="{{ $device['id'] }}"
                                                    class="btn col-md-12 btn-primary btn-open-gate show_transactions">Vehicles</button>
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="col-md-12 col-xs-12 pt-3 ">
                                            ...
                                            <p class="col-md-8 col-xs-8 text-right mb-0 pr-0">
                                                @if (count($device['vehicle_transactions']) > 0)
                                                    <a style="color:white!important" target="_blank"
                                                        href="{{ url('/transaction/2/' . $device['vehicle_transactions']['0']['id']) }}">{{ $device['vehicle_transactions']['0']['vehicle'] }}
                                                        - {{ $device['vehicle_transactions']['0']['time'] }}</a>
                                                @else
                                                    @lang('dashboard.no_transactions')
                                                @endif
                                            </p>
                    ...
                    <div class="table-responsive">
                        <table class="table color-table info-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td><a href="{{ url('/booking/' . $bookings->id) }}"
                                            class="text-link">{{ $bookings->name }}</a></td>
                                    @if ($bookings->low_confidence)
                                        <td class="cursor-pointer text-link"
                                            onclick="edit_vehicle_num({{ $bookings->id }})">
                                            {{ $bookings->vehicle_num }}</td>
                                    @else
                ...
                @if (count($at_location_vehicle) > 0)
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <a href="{{ url('/currently_on_location') }}"
                                class="btn btn-primary">@lang('dashboard.view_more')</a>
                        </div>
                    </div>
                @endif
            </div>
                    ...
                    <table class="table color-table info-table">
                        ...
                        <tbody>
                            @foreach ($last_5_transactions as $key => $transaction)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td><img src="{{ $transaction->image }}" class="img img-responsive h-50 w-50">
                                    </td>
                                    <td><a href="{{ url('/vehicle/' . $transaction->booking_id) }}"
                                            class="text-link">{{ $transaction->vehicle }}</a></td>
    ...
    <div id="view_calender_event" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div id="edit_booking_vehicle_num" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
    ...
    <div id="edit_device_booking_vehicle_num" class="modal fade edit_device_booking_vehicle_num" tabindex="-1"
    ...
    <div id="open_gate_modal" class="modal fade open_gate_modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
                ...
                <div class="modal-body col-md-12">
                    ...
                    <div class="form_con col-md-12">
                        <div class="form-group mb-20 col-md-12 p-0">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control open_gate_vehcile_num" name="vehicle_num"
                        ...
                        <div class="form-group col-md-12 p-0">
                            ...
                            <div class="col-md-9">
                                <textarea rows="7" class="form-control open_gate_reason" name="vehicle_num" placeholder="@lang('dashboard.open_gate_reason_placeholder')"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="confirm_con hidden col-md-12">
                        <div class="form-group mb-20 col-md-12 p-0">
                            <label class="col-md-3">Vehicle Number</label>
                            <div class="col-md-9">
                                <input type="text" readonly=""class="form-control open_gate_vehcile_num"
                                    name="vehicle_num">
                            </div>
                        </div>
                        <div class="form-group col-md-12 p-0">
...
<div id="low_confidence_open_gate_modal" class="modal fade low_confidence_open_gate_modal" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content col-md-12 p-0">
            ...
            <div class="modal-body col-md-12">
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        <img class="open_gate_vehcile_image" src="{{ asset('plugins/images/assets/no_image.png') }}"
                            alt="Transaction" style="width: 100%;">
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group mb-5 col-md-6 p-0">
                        ...
                        <div class="col-md-12">
                            <input type="text" readonly="" class="form-control open_gate_confidence"
                                name="confidence">
                        </div>
                    </div>
                    <div class="form-group mb-5 col-md-6 p-0">
                    ...
                    <div class="form-group mb-5 col-md-12 p-0 open_gate_booking_type_con hidden">
                        ...
                        <div class="col-md-12">
                            <select class="form-control open_gate_booking_type" name="booking_type" onchange="">
                    ...
                    <div class="form-group mb-5 col-md-6 p-0 open_gate_customer_con hidden">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control open_gate_customer" name="open_gate_customer"
                                required="">
                        </div>
                    </div>
                    <div class="form-group mb-5 col-md-6 p-0 open_gate_booking_range_con hidden">
                        ...
                        <div class="col-md-12">
                            <input id="open_gate_booking_range" name="open_gate_booking_range"
                                placeholder="@lang('dashboard.date_range')" type="text"
                                class="form-control open_gate_booking_range input-daterange-datepicker" required=""
                                value="{{ date('d-m-Y') }}" />
                        </div>
                    </div>
                    <div class="form-group mb-5 col-md-12 p-0">
                        ...
                        <div class="col-md-4 update_vehicle_btn_con hidden">
                            <button type="button" class="btn btn-primary submit_low_confidence_open_gate_modal"
                        ...
                        <div class="col-md-4 not_allow_btn_con hidden">
                            <button type="button" class="btn btn-danger submit_low_confidence_open_gate_cancel"
