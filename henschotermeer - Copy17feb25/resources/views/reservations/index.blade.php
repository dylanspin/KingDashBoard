                        ...
                        <div class="col-md-12 text-right">
                            <form method="post" action="{{url('/tommy-reservations/bookings')}}" class="col-md-6 text-right custom-search-form">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="submit" name="reset_btn" class="btn btn-info" value="Reset">
                                </div>
                            </form>
                        </div>
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="listingDataTable" class="table table-striped tommy_reservation_listing">
                                    <thead>
                                    <tr>
                                        <th>@sortablelink('first_name',trans('white-list.name'))</th>
                                        <th>@sortablelink('vehicle_num',trans('booking.vehicle_no'))</th>
