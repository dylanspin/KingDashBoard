    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="side-menu">
				...
				<li class="two-column">
                    <a class="waves-effect" href="{{ url('/history') }}" aria-expanded="false">
                        <!--<i class="fa fa-book fa-fw"></i>--> 
                        <img src="{{asset('/plugins/images/icons/PastBookings.png')}}" 
                             alt="user-img"
                             class="img filter"
                             style="max-width:21px;margin-right:5px;margin-left:11px; margin-top:10px; margin-bottom:10px; padding:0px;">
                        <span class="hide-menu" style="padding-left:18px;"> @lang('sidebar.history')</span>
                    </a>
                </li>
                <li>
                ...
                <li class="two-column">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{asset('products')}}">@lang('sidebar.manage_products')</a></li>
                ...
                <li>
                    <a class="waves-effect" href="{{ url('location/future/bookings') }}">
                        <!--<i class="fa fa-credit-card-alt fa-fw"></i>-->
                        <img src="{{asset('/plugins/images/icons/FutureBookings.png')}}" 
                             alt="user-img"
                             class="img filter"
                             style="max-width:21px;margin-right:5px;margin-left:10px; margin-top:10px; margin-bottom:10px; padding:0px;">
                        <span class="hide-menu" style="padding-left:18px;"> @lang('sidebar.future_bookings')</span>
                    </a>
                </li>
                <li>
                ...
                <li class="two-column">
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false">
                        ...
                        <img src="{{asset('/plugins/images/icons/transactions.png')}}" 
                             ...
                             class="img filter"
                             style="max-width:45px;margin-right:5px;padding:0px;">
                        <span class="hide-menu"> @lang('access-rules.access_rule')</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{asset('manage-rules')}}">@lang('access-rules.manage_rule')</a></li>
                        <li><a href="{{asset('manage-rules/sort')}}">@lang('access-rules.reorder_rule')</a></li>
                    </ul>
                </li>
                <li class="two-column">
                    <a class="waves-effect" href="{{asset('/unwanted-character')}}" aria-expanded="false">
                        <!--<i class="fa fa-group fa-fw"></i>--> 
                        <img src="{{asset('/plugins/images/icons/List.png')}}" 
                             alt="user-img"
                             class="img filter"
                             style="max-width:45px;margin-right:5px;padding:0px;">
                        <span class="hide-menu"> @lang('unwanted_character.character_unwanted')</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{asset('/unwanted-character')}}">@lang('unwanted_character.character_unwanted')</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li class="two-column">
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false">
                        <!--<i class="fa fa-product-hunt fa-fw"></i>-->
                        <img src="{{asset('/plugins/images/icons/printer.png')}}"
                             alt="user-img"
                             class="img filter"
                             style="max-width:45px;margin-right:5px;padding:0px;">
                        <span class="hide-menu"> @lang('sidebar.debug')</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{asset('logs/licence-plates')}}">@lang('sidebar.licence_plate_logs')</a></li>
                    </ul>
                </li>
                @endif
                ...
                <li class="two-column">
                    <a class="waves-effect" href="{{asset('manage-rules')}}" aria-expanded="false">
                        <!--<i class="fa fa-group fa-fw"></i>--> 
                        <img src="{{asset('/plugins/images/icons/transactions.png')}}" 
                             alt="user-img"
                             class="img filter"
                ...
                <li class="two-column">
                    <a class="waves-effect" href="{{asset('/regression')}}" aria-expanded="false">
                        <!--<i class="fa fa-product-hunt fa-fw"></i>-->
                        <img src="{{asset('/plugins/images/icons/setting.png')}}"
                             alt="user-img"
                             class="img filter"
                             style="max-width:45px;margin-right:5px;padding:0px;">
                        <span class="hide-menu"> @lang('sidebar.regression')</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{asset('/regression')}}">@lang('sidebar.regression')</a></li>
                        {{-- <li><a href="{{asset('/regression/download-json-file')}}">@lang('sidebar.export_json')</a></li> --}}
                    </ul>
                </li>
                @endif
