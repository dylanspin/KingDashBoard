...
<!--                <li class="two-column">
                ...
                <li class="two-column">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{asset('barcode')}}">@lang('sidebar.manage_barcodes')</a></li>
                        <li><a href="{{asset('barcode/create')}}">@lang('sidebar.add_new_barcode')</a></li>
                    </ul>
                </li>
<!--                <li class="two-column">
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false">
                ...
                <li class="two-column">
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false">
                        <!--<i class="fa fa-qrcode fa-fw"></i>--> 
                        <img src="{{asset('/plugins/images/icons/Qr_Code.png')}}" 
                             alt="user-img"
                             class="img filter"
                             style="max-width:35px;margin-right:5px;padding:0px;">
                        <span class="hide-menu"> @lang('sidebar.devices')</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{asset('devices')}}">@lang('sidebar.manage_devices')</a></li>
                ...
                <li>
                    <a class="waves-effect" href="{{ url('/logs') }}">
                        <!--<i class="fa fa-gear fa-fw"></i>-->
                        <img src="{{asset('/plugins/images/icons/setting.png')}}" 
                             alt="user-img"
                             class="img filter"
                             style="max-width:45px;margin-right:5px;padding:0px;">
                        <span class="hide-menu"> @lang('sidebar.error_logs')</span>
                    </a>
                </li>
                @endif
