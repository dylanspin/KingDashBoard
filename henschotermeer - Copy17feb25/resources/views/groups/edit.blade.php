...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">@lang('groups.edit_group')</h3>
                    ...
                    @endif
                    <form id="commentForm" action="{{ url('group/edit/' . $group->id) }}" method="POST"
                        enctype="multipart/form-data" class="form-horizontal groupForm">
                        <!-- CSRF Token -->
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group {{ $errors->first('name', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="name" name="name" type="text"
                                                placeholder="@lang('groups.name')" class="form-control required"
                                    ...
                                    <div class="form-group {{ $errors->first('device', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="select2 select2-multiple" title="@lang('groups.device_title')"
                                                name="device[]" multiple="multiple" data-placeholder="Choose">
                                                @foreach ($devices as $index => $device)
                                                    <option value="{{ $device->id }}"
                                                        @if (in_array($device->id, $groupr_devices)) selected @endif>
                                                        {{ $device->device_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-10 col-md-offset-2">
                                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                                <input type="checkbox" id="has_anti_pass_back"
                                                    class="form-control has_anti_pass_back" name="has_anti_pass_back"
                                                    {{ $group->has_anti_pass_back == 1 ? 'checked' : '' }}>
                                    ...
                                    @if ($group->group_max)
                                        <div class="form-group">
                                            <div class="col-md-10 col-md-offset-2">
                                                <div class="checkbox checkbox-primary pull-left p-t-0">
                                                    <input type="checkbox" id="total_spots" class="form-control total_spots"
                                                        name="total_spots" checked>
                                                    <label for="total_spots"> @lang('products.vehicle_allowed') </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group {{ $errors->first('no_of_vehicle', 'has-error') }}"
                                            id="nums_of_vehicle">
                                            <label for="no_of_vehicle"
                                                class="col-sm-2 control-label ">@lang('products.vehicle_allowed')</label>
                                            <div class="col-sm-10">
                                                <input id="no_of_vehicle" name="no_of_vehicle" type="text"
                                                    placeholder="@lang('products.no_of_vehicle')" class="form-control required"
                                                    value="{{ $group->group_max }}" />
...
@push('js')
    ...
    <script src="{{ asset('plugins/components/bootstrap-select/bootstrap-select.min.js') }}" type="text/javascript">
    </script>
    <script src="{{ asset('plugins/components/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js') }}"></script>
    <script src="{{ asset('plugins/components/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js') }}"
