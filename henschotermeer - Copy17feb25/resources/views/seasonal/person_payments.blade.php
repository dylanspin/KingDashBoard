...
@section('content')
    <div class="container-fluid">
                ...
                <div class="white-box">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <form method="post" action="{{ url('/seasonal/person') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($bookingPayment->is_blocked)
                                                        <button type="button" class="btn btn-danger btn-sm blockedPerson"
                                                            data-id="{{ $bookingPayment->booking_id }}"
                                                            id="unblocked-person"
                                                            onclick="unblock_seasonal_person({{ $bookingPayment->booking_id }})"><i
                                                                class="fa fa-lock"></i></button>
                                                    @else
                                                        <button type="button" class="btn btn-success btn-sm unblockedPerson"
                                                            data-id="{{ $bookingPayment->booking_id }}" id="blocked-person"
                                                            onclick="block_seasonal_person({{ $bookingPayment->booking_id }})"><i
                                                    ...
                                                    <button type="button" class="btn btn-primary seasonalPersonEdit"
                                                        data-id="{{ $bookingPayment->booking_id }}"
                                                        id="edit-subscription"><i class="fa fa-edit"></i></button>
                                                    <button type="button" class="btn btn-danger seasonalPersonDelete"
                                                        id="Delbutton" data-id="{{ $bookingPayment->booking_id }}"
                ...
                <form method="POST" action="{{ url('seasonal/update') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group onedate">
                            <label class="control-label">@lang('payments.dob')</label>
                            <div class='input-group date ' id='datetimepicker3'>

                                <input type='text' class="form-control date-of-birth" id="datetime3"
                                    name="date_of_birth" />
        ...
        <div id="deleteModal" class="modal fade">
            <form method="POST" action="{{ url('seasonal/delete') }}">
                @csrf
        ...
        <div id="blockSeasonalPerson" class="modal fade">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    <form action="{{ url('seasonal/block-unblock-person') }}" method="POST">
                        @csrf
                        <div class="modal-header flex-column">
                            <div class="icon-box">
                                <i class="fa fa-exclamation"></i>
                        ...
                        <div class="modal-body">
                            <p>@lang('payments.block_seasonal_person') </p>
                        </div>
                        <div class="modal-footer justify-content-center">
        ...
        <div id="unblockSeasonalPerson" class="modal fade">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    <form action="{{ url('seasonal/block-unblock-person') }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-body">
                            <p>@lang('payments.unblock_seasonal_person') </p>
                        </div>
                        <div class="modal-footer justify-content-center">
...
@push('js')
    ...
    <script>
        ...
        $(".seasonalPersonDelete").click(function() {
        ...
        function block_seasonal_person(booking_id) {
            $("#blocked_booking_id").val(booking_id);
            $("#blockSeasonalPerson").modal('show');
        }

        function unblock_seasonal_person(booking_id) {
            $("#unblocked_booking_id").val(booking_id);
            $("#unblockSeasonalPerson").modal('show');
        }
    </script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.4.0/bootbox.min.js"></script>
@endpush
