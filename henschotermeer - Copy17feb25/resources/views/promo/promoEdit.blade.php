    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <form 
                    id="commentForm" 
                    action="{{url('promo/edit/'.$promos->id)}}" 
                    method="POST" 
                                ...
                                <div class="form-group {{ $errors->first('valid_dates', 'has-error') }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input 
                                            ...
                                            value="{{date('d-m-Y',strtotime($promos->start_date ))}} - {{date('d-m-Y',strtotime($promos->end_date ))}}" 
                                            required=""/>
...
<div class="form-group {{ $errors->first('valid_group_no', 'has-error') }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input 
                                            ...
                                            type="number" 
                                            class="form-control valid_group_no " 
                                            value="{{$promos->promo_number_limit}}" 
                                            required=""/>
