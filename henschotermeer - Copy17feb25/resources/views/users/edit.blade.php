...
<style>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Edit @lang('sidebar.employees')</h3>
                    <div class="clearfix"></div>
                    <form id="userForm" action="{{url('user/edit/'.$user->id)}}"
                        ...
                        <div id="rootwizard">
                            ...
                            <div class="form-group {{ $errors->first('email', 'has-error') }}">
                                ...
                                <div class="col-sm-10">
                                    <input id="email" name="email" placeholder="E-mail" type="text"
                                           class="form-control required email" disabled="" value="{{$user->email}}"/>
                            ...
                            <ul class="pager wizard">
                                <li class="next finish" ><a href="javascript:;">Update</a></li>
                            </ul>
                        </div>
                    </form>
