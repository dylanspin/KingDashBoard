    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading">@lang('user-list.create_userlist')</div>
                <div class="panel-wrapper collapse in" aria-expanded="true">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->first('access_rights', 'has-error') }}">
                                        ...
                                        <select class="form-control" title="@lang('user-list.access_right_title')" name="access_rights">
                                            ...
                                            <option 
                                                value="{{$right->id}}"
                                                @if(old('access_rights') == $right->id) selected="selected" @endif >{{$right->name}}
                                        </option>
                                        @endforeach
                                    </select>
                    ...
                    <h3 class="box-title m-t-40">@lang('user-list.Add_vehicles')</h3>
                    <hr>
                    <div class="row add_new_vehicles">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label> @lang('customer.add_more') </label>
                                <div class="row"><div class="col-md-8">
                                        <input type="text" class="form-control required" name="plates[]" placeholder="@lang('customer.new_plate')" required>
                                    </div>
                                    <div class="col-md-4">
                                        <!--<button type="button" class="btn btn-danger remove_btn" onclick="remove_vehicle(this)">Remove</button>-->
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <button type="button"  class="btn btn-success add_more_btn">@lang('user-list.add_new_plate')</button>
                    <hr>
                        ...
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                <input 
                                    ...
                                    {{old('user_arrival_notification') ? 'checked' : ''}}> 
                                <label for="user_arrival_notification"> @lang('customer.user_arrival_notification') </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group notify_email{{old('user_arrival_notification') ? '' : ' hidden'}} {{ $errors->first('notify_emails', 'has-error') }}">
