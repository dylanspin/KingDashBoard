...
<style>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">@lang('products.day_ticket')</h3>
                    ...
                    <form 
                        id="dayTicketForm" 
                        action="{{url('products/day_ticket')}}" 
                        method="POST" 
                        enctype="multipart/form-data" 
                        class="form-horizontal dayTicketForm">
                        <!-- CSRF Token -->
    ...
    <script src="{{ asset('/js/day_ticket.js') }}"></script>
