            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12 text-left">
                        <form method="post" action="{{url('logs/access-detials/device-details/'.$id)}}" class="col-md-12 custom-search-form">
                            @csrf
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <a href="{{ url('/logs/access-detials/device-details/'.$id) }}" type="submit" name="reset_btn" class="btn btn-danger">Reset</a>
                            </div>
                        </form>
                    </div>
                    <div class="col-md-12">
                            ...
                            <table class="table" data-sorting="true" data-filtering="true" data-filter-connectors="false" data-show-toggle="false" data-toggle-column="first" data-paging="false">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{$log->message}} {{ $log->device_booking_id }}
                                        </td>
                                    ...
                                    <tr id="extra_details_{{$log->id}}" class="hidden">
                                        ...
                                        <td>
                                            @if ($log_image->file_path !=null || $log_image->file_path !='')
