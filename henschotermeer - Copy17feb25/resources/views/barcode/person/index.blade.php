    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <a  class="btn btn-success pull-right" href="{{url('person/barcode/create')}}"><i class="icon-plus"></i> @lang('barcode.add_barcode')</a>
...
$(document).ready(function () {
    $(document).on('click', '.delete', function (e) {
        ...
        title: "Destroy Barcode?",
            ...
            if (result){
            window.location.href = "{{url('person/barcode/delete')}}/" + id;
            }
            }
        });
    });
