        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form 
                        id="commentForm" 
                        action="{{url('barcode/edit/'.$barcode->id)}}" 
                        method="POST" 
                        ...
                        <div id="rootwizard">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group {{ $errors->first('barcode', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input 
                                                ...
                                                value="{!! old('barcode', $barcode->barcode) !!}" readonly onclick="Random();"/>
                                    ...
                                    <div class="form-group {{ $errors->first('vehicle_no', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input 
                                                ...
                                                name="vehicle_no" 
                                                type="text" 
                                                placeholder="@lang('barcode.vehicle_no')" 
                                                class="form-control required" 
                                                value="{!! old('vehicle_no', $barcode->vehicle_no) !!}"/>

                                            {!! $errors->first('vehicle_no', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                    @if (isset($barcode->valid_till))
                                    ...
                                    @endif
                                    @if ($barcode->use_barcode_multiple_time)
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-10 col-md-offset-2">
                                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                                <input type="checkbox" id="multiple_times"
                                                    class="form-control multiple_times" name="multiple_times">
                                                <label for="multiple_times"> @lang('barcode.multiple_times') </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea 
                                                ...
                                                rows="6">{!! old('message', $barcode->message) !!}</textarea>
                                        </div>
