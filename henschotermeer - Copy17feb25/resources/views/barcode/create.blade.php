        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <a class="btn btn-success pull-right" href="{{ url('barcode/') }}">
                    ...
                    @endif
                    <form id="commentForm" action="{{ url('barcode/create') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group {{ $errors->first('barcode', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="barcode" name="barcode" type="text"
                                                placeholder="@lang('barcode.barcode')" class="form-control required"
                                                value="{!! old('barcode') !!}" onclick="Random();" readonly />
                                    ...
                                    <div class="form-group {{ $errors->first('name', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="name" name="name" type="text"
                                                placeholder="@lang('barcode.name')" class="form-control required"
                                                value="{!! old('name') !!}" />
                                    ...
                                    <div class="form-group {{ $errors->first('vehicle_no', 'has-error') }}">
                                        <label for="vehicle_no" class="col-sm-2 control-label">@lang('barcode.vehicle_no')</label>
                                        <div class="col-sm-10">
                                            <input id="vehicle_no" name="vehicle_no" type="text"
                                                placeholder="@lang('barcode.vehicle_no')" class="form-control required"
                                                value="{!! old('vehicle_no') !!}" />

                                            {!! $errors->first('vehicle_no', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                    <div class="form-group {{ $errors->first('valid_till', 'has-error') }} hidden">
                                        <label for="valid_till" class="col-sm-2 control-label">@lang('barcode.valid_till')</label>
                                        <div class="col-sm-10">
                                            <input id="valid_till" name="valid_till" type="text"
                                                placeholder="@lang('barcode.valid_till')" class="form-control required"
                                                value="{!! old('valid_till') !!}" />

                                            {!! $errors->first('valid_till', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-10 col-md-offset-2">
                                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                                <input type="checkbox" id="multiple_times"
                                                    class="form-control multiple_times" name="multiple_times" checked>
                                                <label for="multiple_times"> @lang('barcode.multiple_times') </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="message" id="message" class="form-control resize_vertical message" rows="6">{!! old('message') !!}</textarea>
                                        </div>
