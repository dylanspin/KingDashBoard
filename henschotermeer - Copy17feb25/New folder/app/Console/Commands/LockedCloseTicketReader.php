...
class LockedCloseTicketReader extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:LockedCloseTicketReader {device}';
     ...
     * @var string
     */
    protected $description = 'Gate permanently closed';
    ...
    public function handle()
    {
        ...
        if ($device && $device->barrier_status != 2) {
            $details = array();
            $ip = $device->device_ip;
