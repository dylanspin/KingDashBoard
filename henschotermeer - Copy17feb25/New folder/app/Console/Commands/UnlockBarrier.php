...
class UnlockBarrier extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:UnlockBarrier {device}';
     ...
     * @var string
     */
    protected $description = 'Barrier go back to its normal position';
    ...
    public function handle()
    {
        ...
        if ($device && $device->barrier_status != 0) {
            ...
            $command = 'unlock_gate';
            $data = '42|' . $key . '|'.$device->barrier_status;
