                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="listingDataTable" class="table table-striped tommy_reservation_listing">
                                    <thead>
                                    <tr>
                                        <th>@lang('tommy-reservation.name')</th>
                                    ...
                                    <tbody>
                                    @foreach($tommyReservations->tommy_reservation_childrens as $tommyReservation)
                                        <tr>
                                            <td>{{$tommyReservation->name}}</td>
                                            ...
                                            <td>  
                                                <a 
                                                    ...
                                                    href="{{url('tommy-reservations/print-ticket/'.$tommyReservation->id)}}">
