...
<section id="wrapper" class="login-register">
    <div class="login-box">
        <div class="white-box pull-left col-md-12">
            <form class="form-horizontal form-material" method="POST"  action="{{ route('wizard_step_4_submit') }}">
                @csrf
                <div class="form-group ">
                    <div class="col-xs-12">
                        <h3 class="text-center">{{ __('Welcome to Parkingshop') }}</h3>
                        <p class="text-muted text-center">@lang('wizard.conf_ticket_reader')</p>
                    </div>
                </div>
                ...
                @for ($i = 0; $i < $ticket_readers; $i++)
                <div class="col-md-4">
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input id="device_name" placeholder="@lang('wizard.name_ticket_reader') {{ $i + 1 }}" type="text" class=" form-control device_name" name="device_name[]" value="" >
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input id="ip" placeholder="@lang('wizard.ip_treader') {{ $i + 1 }}" type="text" class=" form-control ip" name="ip[]" value="" >
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input id="port" placeholder="@lang('wizard.port_treader') {{ $i + 1 }}" type="text" class="only_num form-control port" name="port[]" value="" >
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                ...
                <div class="col-md-12">
                    <div class="form-group text-center m-t-20 col-md-2 pull-right">
                        ...
                        <div class="form-group text-center m-t-5">
                            <a href="{{url('/wizard-step-5')}}" class="text-muted">lang('wizard.skip')</a>
                        </div>
                    </div>
                </div>
            </form>
