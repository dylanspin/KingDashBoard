...
<!--                <p class="pull-right">
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <form method="post" action="{{url('/day/person')}}" class="col-md-6 text-right custom-search-form">
                            @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary editPersonTicket" data-id="{{ $bookingPayment->booking_id}}"  data-toggle="modal" data-target="#exampleModal" id="edit-subscription"><i class="fa fa-edit"></i></button>
              ...
              $.ajax({
                  ...
                  success: function (data) {
                    console.log(data.booking_payments.amount)
                      ...
                      $('#datetime1').val(d + "-" + m + "-" + Y+ "  "+ hour + ":" + minutes + ":" + seconds);                      var formattedDatee = new Date(data.checkout_time);
