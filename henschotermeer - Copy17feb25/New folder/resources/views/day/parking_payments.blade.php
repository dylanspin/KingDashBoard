                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="listingDataTable" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>@sortablelink('email',trans('payments.no'))</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary editParkingTicket" data-id="{{ $bookingPayment->booking_id}}"  data-toggle="modal" data-target="#exampleModal" id="edit-subscription"><i class="fa fa-edit"></i></button>
  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
       ...
       <a href = "{{url('day/delete/'.$bookingPayment->booking_id) }}"> <button type="button" class="btn btn-danger">@lang('reservations.delete')</button></a>
      </div>
    </div>
  </div>
</div>  
