...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title pull-left">TRANSACTION DETAILS</h3>
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <form method="post" action="{{url('/transaction_details')}}" class="col-md-6 text-right custom-search-form">
                            @csrf
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@sortablelink('vehicle_num',trans('at_location.vehicle'))</th>
