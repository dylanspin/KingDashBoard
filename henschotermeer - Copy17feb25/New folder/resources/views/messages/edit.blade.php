        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form 
                        id="commentForm" 
                        action="{{url('messages/edit/'.$message_details->id)}}" 
                        method="POST" 
                                ...
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group {{ $errors->first('device_name', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9 pt-5">
                                            <input type="hidden" name="message_key" value="{{$message_details->id}}"
                                                   <label for="message_key" class="col-sm-9 control-label pt-10"><b>{{$message_details->key}}</b></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_en', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                value="{!! old('lang_en', $message_details->en) !!}"/>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_nl', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                placeholder="@lang('messages.message_in') {{$lang->name}} ({{$lang->country}})" 
                                                class="form-control required" 
                                                value="{!! old('lang_nl', $message_details->nl) !!}"/>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_fr', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                placeholder="@lang('messages.message_in') {{$lang->name}} ({{$lang->country}})" 
                                                class="form-control required" 
                                                value="{!! old('lang_fr', $message_details->fr) !!}"/>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_es', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                placeholder="@lang('messages.message_in') {{$lang->name}} ({{$lang->country}})" 
                                                class="form-control required" 
                                                value="{!! old('lang_es', $message_details->es) !!}"/>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_no', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                placeholder="@lang('messages.message_in') {{$lang->name}} ({{$lang->country}})" 
                                                class="form-control required" 
                                                value="{!! old('lang_no', $message_details->no) !!}"/>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_gr', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                placeholder="@lang('messages.message_in') {{$lang->name}} ({{$lang->country}})" 
                                                class="form-control required" 
                                                value="{!! old('lang_gr', $message_details->gr) !!}"/>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_de', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                placeholder="@lang('messages.message_in') {{$lang->name}} ({{$lang->country}})" 
                                                class="form-control required" 
                                                value="{!! old('lang_gr', $message_details->de) !!}"/>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_fy', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                placeholder="@lang('messages.message_in') {{$lang->name}} ({{$lang->country}})" 
                                                class="form-control required" 
                                                value="{!! old('lang_fy', $message_details->fy) !!}"/>
                                    ...
                                    <div class="form-group {{ $errors->first('lang_dr', 'has-error') }}">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                                ...
                                                placeholder="@lang('messages.message_in') {{$lang->name}} ({{$lang->country}})" 
                                                class="form-control required" 
                                                value="{!! old('lang_dr', $message_details->dr) !!}"/>

                                            {!! $errors->first('lang_dr', '<span class="help-block">:message</span>') !!}
                                        </div>
                                        <span class="help-block">{{ $errors->first('lang_dr', ':message') }}</span>
                                    </div>
