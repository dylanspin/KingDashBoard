...
<!--                <p class="pull-right">
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <form method="post" action="{{url('/seasonal/parking')}}" class="col-md-6 text-right custom-search-form">
                            @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary seasonalParkingEdit" data-id="{{ $bookingPayment->booking_id}}"  data-toggle="modal" data-target="#exampleModal" id="edit-subscription"><i class="fa fa-edit"></i></button>
