...
<html>
    ...
    <body style="width: 86mm;height: 55mm;margin: 0px;padding: 0px;">
        ...
        <div style="text-align:left;margin: 0px;padding: 0px;width: 70%">
            <img 
                src="data:image/png;base64,{{ \Milon\Barcode\DNS1D::getBarcodePNG($barcode_number, 'C128',2,33)}}" 
                alt="barcode" 
                />
        </div>
        <div style="width:100%;float: left; text-align: left;margin: 0px;padding: 0px;">
            <p style="margin-top:10px!important;margin-bottom: 0px;font-size:12px;">@lang('pdf.name') {{ $barcode->name ? $barcode->name : $barcode->barcode }}</p>
        </div>
